...
namespace Db2_Design.Controllers
{
    public class BusinessesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BusinessID,BusinessTypeID,UserID,BusinessName,Address,PhoneNumber,Menu")] Business business)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BusinessID,BusinessTypeID,UserID,BusinessName,Address,PhoneNumber,Menu")] Business business)
        {
            if (ModelState.IsValid)
            {
